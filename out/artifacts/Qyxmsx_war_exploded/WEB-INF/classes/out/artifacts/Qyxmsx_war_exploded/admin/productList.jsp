...
<div class="rightinfo">
    ...
    <div class="tools">
        <ul class="toolbar">
            ...
            <li class="click"><span><img src="<c:url value='/admin/images/t03.png' />" />
				</span>删除</li>
        </ul>
        ...
        <form action="#" method="post">
            <ul class="seachform">
                <li><label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    按关键字&nbsp;&nbsp;</label><input name="" type="text" class="scinput" />
                </li>
                <li><label>查询&nbsp;&nbsp;按</label>
                    <div class="vocation">
    ...
    <table class="tablelist" >
        ...
        <c:forEach var="item" items="${page.list}">
            <tr>
                ...
                <td>${item.cname}</td>
                <td>${item.time}</td>
                <td><a href="<c:url value='/AdminProductServlet?action=find&id=${item.productid}' />" class="tablelink">查看</a> <a
                        href="updateProduct.html" class="tablelink"> 修改</a> <a href="#"
                                                                               class="click"> 删除</a>
                </td>
            </tr>
        </c:forEach>
        ...
        <ul class="paginList">
            <c:choose>
                ...
                <c:otherwise>
                    <li class="paginItem"><a
                            href="<c:url value='/AdminProductServlet?action=findAll&current=${page.currentPage-1}' />"><span
                            class="pagepre"></span>
                    </a>
                    </li>
                </c:otherwise>
            ...
            <c:forEach var="i" begin="${page.start}" end="${page.end}">
                <c:choose>
                    ...
                    <c:otherwise>
                        <li class="paginItem"><a
                                href="<c:url value='/AdminProductServlet?action=findAll&current=${i}' />">${i}</a>
                        </li>
                    </c:otherwise>
                </c:choose>
            </c:forEach>
    ...
    <div class="tip">
        ...
        <div class="tipinfo">
				<span><img src="<c:url value='/admin/images/ticon.png' />" />
				</span>
            <div class="tipright">
                <p>是否确认对信息的修改 ？</p>
