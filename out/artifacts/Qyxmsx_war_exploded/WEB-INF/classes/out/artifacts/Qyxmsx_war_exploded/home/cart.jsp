...
<link href="<c:url value='/AmazeUI-2.4.2/assets/css/amazeui.css'/>"
	rel="stylesheet" type="text/css" />d
						...
						<div class="bundle  bundle-last ">
							...
							<div class="bundle-main">
								<ul class="item-content clearfix">
									...
									<li class="td td-item">
										<div class="item-pic">
											<a href="#" target="_blank" data-title="" class="J_MakePoint" data-point="tbcart.8.12">
												<img style="width: 100%" src="<c:url value='${item.photo}' />" class="itempic J_ItemImg"></a>
										</div>
										<div class="item-info">
											<div class="item-basic-info">
												<a href="#" target="_blank" title="" class="item-title J_MakePoint" data-point="tbcart.8.11">${item.name}</a>
											</div>
										</div>
									</li>
										...
										<div class="amount-wrapper ">
											<div class="item-amount ">
												<div class="sl">
													...
													<input class="text_box" name="buycount" type="text" productid="${item.productid}" value="${item.buycount}" style="width:30px;" />
									...
									<li class="td td-sum">
										<div class="td-inner">
											<span tabindex="0"id="total${item.productid}" class="J_ItemSum number">${item.total}</span>
										</div>
									</li>
									<li class="td td-op">
										<div class="td-inner">
