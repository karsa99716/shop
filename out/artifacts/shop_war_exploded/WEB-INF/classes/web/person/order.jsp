...
<body>
	...
	<div class="nav-table">
		...
		<div class="nav-cont">
			<ul>
				<li class="index"><a href="<c:url value='/home/index.jsp'/>">首页</a>
				</li>
				<li class="qc"><a href="<c:url value='/home/cart.jsp'/>">购物车</a>
				</li>
				<li class="qc"><a href="<c:url value='/OrderServlet?action=findAll'/>">我的订单</a>
				</li>
				<li class="qc last"><a
					href="#">个人中心</a>
				</li>
										...
										<div class="order-list">
											...
											<div class="order-status5">
												<div class="order-title">
													<div class="dd-num">订单编号：<a href="javascript:;">${orderitem.orderid}</a></div>
													<span><fmt:formatDate type="time" value="${orderitem.ordertime }" pattern="yyyy-MM-dd hh:mm:ss" /></span>
												</div>
												<div class="order-content">
													<div class="order-left">
														<c:forEach var="item" items="${orderitem.orderItemList}">
														<ul class="item-list">
															<li class="td td-item">
																<div class="item-pic">
														...
														<div class="move-right">
															<li class="td td-status">
																<div class="item-status">
																	<c:choose>
																		<c:when test="${orderitem.statuss==0}">
																			<p class="Mystatus">等待付款</p>
																		</c:when>
																		<c:when test="${orderitem.statuss==1}">
																			<p class="Mystatus">等待发货</p>
																		</c:when>
																		<c:when test="${orderitem.statuss==2}">
																			<p class="Mystatus">等待收货</p>
																		</c:when>
																		<c:when test="${orderitem.statuss==3}">
																			<p class="Mystatus">等待评价</p>
																		</c:when>
																	</c:choose>
																	<p class="order-info"><a href="<c:url value='/OrderServlet?action=findById&id=${orderitem.orderid}' />">订单详情</a></p>
		...
		<aside class="menu">
			<ul>
				...
				<li class="person">
					...
					<ul>
						<li><a href="<c:url value='/OrderServlet?action=findAll'/>">订单管理</a></li>
