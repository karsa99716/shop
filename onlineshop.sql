...
CREATE TABLE `activate`  (
  `activateid` int(0) NOT NULL AUTO_INCREMENT COMMENT '激活码id',
  `code` varchar(100) CHARACTER SET utf8 COLLATE utf8_bin NULL DEFAULT NULL COMMENT '激活码',
  `expiredate` datetime(0) NULL DEFAULT NULL COMMENT '过期时间',
  `vipid` int(0) NULL DEFAULT NULL COMMENT '所属会员',
  PRIMARY KEY (`activateid`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 30 CHARACTER SET = utf8 COLLATE = utf8_bin ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of activate
-- ----------------------------
INSERT INTO `activate` VALUES (28, 'e6e5c3c3b45f4df181386134fbc0db03', '2020-12-29 13:21:10', 1);
INSERT INTO `activate` VALUES (29, '141bad871d4841839e9a017b155fabd5', '2020-12-29 13:22:00', 2);
INSERT INTO `activate` VALUES (30, '1e61f6d0bf3f499890baa85a79bfe16d', '2020-12-30 19:09:12', 3);
...
CREATE TABLE `address`  (
  ...
  `addressname` varchar(200) CHARACTER SET utf8 COLLATE utf8_bin NULL DEFAULT NULL COMMENT '详细地址',
  ...
  `area` varchar(50) CHARACTER SET utf8 COLLATE utf8_bin NULL DEFAULT NULL COMMENT '区',
  `postcode` varchar(32) CHARACTER SET utf8 COLLATE utf8_bin NULL DEFAULT NULL COMMENT '邮编',
  `receiver` varchar(50) CHARACTER SET utf8 COLLATE utf8_bin NULL DEFAULT NULL COMMENT '收件人',
  `phone` varchar(32) CHARACTER SET utf8 COLLATE utf8_bin NULL DEFAULT NULL COMMENT '电话',
  `vipid` int(0) NULL DEFAULT NULL COMMENT '关联用户id',
...
-- Records of address
-- ----------------------------
INSERT INTO `address` VALUES (1, 'gjc', '河南省', '洛阳市', '涧西区', '471000', '耿嘉程', '15690660506', 1);
INSERT INTO `address` VALUES (2, 'gjc', '河南省', '洛阳市', '涧西区', '471000', '耿嘉程', '15690660506', 2);
INSERT INTO `address` VALUES (3, 'g', '河南省', '郑州市', '中原区', '471000', '耿', '15690660506', 1);
...
-- ----------------------------
-- Table structure for basecount
-- ----------------------------
DROP TABLE IF EXISTS `basecount`;
...
CREATE TABLE `category`  (
  `categoryid` int(0) NOT NULL AUTO_INCREMENT COMMENT '商品的id',
  `name` varchar(50) CHARACTER SET utf8 COLLATE utf8_bin NULL DEFAULT NULL COMMENT '商品名称',
  `sort` int(0) NULL DEFAULT NULL COMMENT '商品的分类',
...
-- Records of category
-- ----------------------------
INSERT INTO `category` VALUES (1, '水果', 1);
INSERT INTO `category` VALUES (2, '零食', 2);
INSERT INTO `category` VALUES (3, '手机', 3);
INSERT INTO `category` VALUES (4, '生活用品', 5);
INSERT INTO `category` VALUES (5, '车载导航', 6);
...
CREATE TABLE `orderitem`  (
  `id` int(0) NOT NULL AUTO_INCREMENT COMMENT '订单 条目编号',
  `buycount` int(0) NULL DEFAULT NULL COMMENT '购买此商品的数量',
  `totalprice` float NULL DEFAULT NULL COMMENT '购买此商品的总价',
  `productid` int(0) NULL DEFAULT NULL COMMENT '购买商品的编号',
  `name` varchar(50) CHARACTER SET utf8 COLLATE utf8_bin NULL DEFAULT NULL COMMENT '商品名称',
  `price` float NULL DEFAULT NULL COMMENT '商品单价',
  `photo` varchar(200) CHARACTER SET utf8 COLLATE utf8_bin NULL DEFAULT NULL COMMENT '商品封面',
  `orderid` varchar(50) CHARACTER SET utf8 COLLATE utf8_bin NULL DEFAULT NULL COMMENT '所属订单编号',
  PRIMARY KEY (`id`) USING BTREE,
...
-- ----------------------------
INSERT INTO `orderitem` VALUES (43, 1, 15.9, 2, '果脯', 15.9, 'uploadimages/6e1f6ce30d2c4185836e4a5be0bb8cb9下载 (2).jpg', '27ae61edd1ed440ebb5a464e3cbcbb35');
INSERT INTO `orderitem` VALUES (44, 2, 398, 1, '车载导航', 199, 'uploadimages/ce8bb14c88674c9d8078294fc9d6e955下载 (3).jpg', '12d4133f680c423787084a1511c11878');
...
CREATE TABLE `orders`  (
  `orderid` varchar(50) CHARACTER SET utf8 COLLATE utf8_bin NOT NULL COMMENT '订单编号',
  `ordertime` datetime(0) NULL DEFAULT NULL,
  `statuss` int(0) NULL DEFAULT NULL,
  `addressname` varchar(200) CHARACTER SET utf8 COLLATE utf8_bin NULL DEFAULT NULL,
  `postcode` varchar(32) CHARACTER SET utf8 COLLATE utf8_bin NULL DEFAULT NULL,
  `receiver` varchar(50) CHARACTER SET utf8 COLLATE utf8_bin NULL DEFAULT NULL,
  `phone` varchar(32) CHARACTER SET utf8 COLLATE utf8_bin NULL DEFAULT NULL,
  `totalprice` float NULL DEFAULT NULL,
  `content` varchar(400) CHARACTER SET utf8 COLLATE utf8_bin NULL DEFAULT NULL,
  `vipid` int(0) NULL DEFAULT NULL,
  PRIMARY KEY (`orderid`) USING BTREE,
  INDEX `vipid`(`vipid`) USING BTREE,
  CONSTRAINT `vipid` FOREIGN KEY (`vipid`) REFERENCES `user` (`vipid`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE = InnoDB CHARACTER SET = utf8 COLLATE = utf8_bin ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of orders
-- ----------------------------
INSERT INTO `orders` VALUES ('12d4133f680c423787084a1511c11878', '2020-12-29 19:24:55', 0, '河南省郑州市中原区', '471000', '耿', '15690660506', 398, '', 1);
INSERT INTO `orders` VALUES ('27ae61edd1ed440ebb5a464e3cbcbb35', '2020-12-28 13:30:18', 0, '河南省洛阳市涧西区', '471000', '耿嘉程', '15690660506', 15.9, '', 1);
...
CREATE TABLE `product`  (
  `productid` int(0) NOT NULL AUTO_INCREMENT COMMENT '商品唯一id号',
  `name` varchar(50) CHARACTER SET utf8 COLLATE utf8_bin NOT NULL COMMENT '商品名称',
  `price` float NULL DEFAULT NULL COMMENT '价格',
  `markprice` float NULL DEFAULT NULL COMMENT '市场价',
  `quality` int(0) NULL DEFAULT NULL COMMENT '库存量',
  `hit` int(0) NULL DEFAULT NULL COMMENT '浏览量',
  `time` date NULL DEFAULT NULL COMMENT '上架时间',
  `photo` varchar(200) CHARACTER SET utf8 COLLATE utf8_bin NULL DEFAULT NULL COMMENT '商品介绍',
  `content` text CHARACTER SET utf8 COLLATE utf8_bin NULL COMMENT '所属分类id，外键',
...
-- Records of product
-- ----------------------------
INSERT INTO `product` VALUES (1, '车载导航', 199, 219, 321, 5646789, '2020-12-10', 'uploadimages/ce8bb14c88674c9d8078294fc9d6e955下载 (3).jpg', '<p>车载导航</p>\r\n', 5);
INSERT INTO `product` VALUES (2, '果脯', 15.9, 19.9, 9999, 999999, '2020-08-12', 'uploadimages/6e1f6ce30d2c4185836e4a5be0bb8cb9下载 (2).jpg', '<p>果脯</p>\r\n', 1);
INSERT INTO `product` VALUES (3, '扫地机器人', 155, 188, 8979, 19999, '2020-07-08', 'uploadimages/4862d0d7bbe94855a1e06dc907afa917sd.jpg', '<p>扫地机器人</p>\r\n', 4);
INSERT INTO `product` VALUES (4, '芒果干', 18, 19, 9999, 432155, '2020-09-21', 'uploadimages/c2b3eaf71ff940db9c176853bd6be2a8u=3866691497,3667295269&fm=26&gp=0.jpg', '<p>芒果干</p>\r\n', 2);
INSERT INTO `product` VALUES (5, 'IQOO', 2799, 3299, 2222, 2222222, '2020-11-06', 'uploadimages/dc09a611b08e40ec9efdbf636fdf7824O1CN0158WUJb1VubAq9LU4e_!!1824502713.jpg_430x430q90.jpg', '<p>IQOO手机全新上市</p>\r\n', 3);
...
CREATE TABLE `user`  (
  `vipid` int(0) NOT NULL AUTO_INCREMENT COMMENT '会员id',
  ...
  `sex` varchar(10) CHARACTER SET utf8 COLLATE utf8_bin NULL DEFAULT NULL COMMENT '性别',
  `email` varchar(50) CHARACTER SET utf8 COLLATE utf8_bin NULL DEFAULT NULL COMMENT '邮箱',
  `photo` varchar(255) CHARACTER SET utf8 COLLATE utf8_bin NULL DEFAULT NULL COMMENT '头像',
  `score` bigint(0) NULL DEFAULT NULL COMMENT '用户积分判断等级',
  `question` varchar(100) CHARACTER SET utf8 COLLATE utf8_bin NULL DEFAULT NULL COMMENT '密码提示问题',
  `answer` varchar(200) CHARACTER SET utf8 COLLATE utf8_bin NULL DEFAULT NULL COMMENT '答案',
...
-- Records of user
-- ----------------------------
INSERT INTO `user` VALUES (1, 'gjc', '202cb962ac59075b964b07152d234b70', NULL, '2420438252@qq.com', NULL, 0, NULL, NULL, '2020-12-29 19:10:55', 1);
INSERT INTO `user` VALUES (2, 'gjc1', '202cb962ac59075b964b07152d234b70', NULL, '2420438252@qq.com', NULL, 0, NULL, NULL, '2020-12-28 14:22:52', 1);
INSERT INTO `user` VALUES (3, '123123', '202cb962ac59075b964b07152d234b70', NULL, '2420438252@qq.com', NULL, 0, NULL, NULL, '2020-12-29 19:09:12', 1);
